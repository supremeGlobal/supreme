    ...
    <div class="page">
        ...
        @php
            $jobs = [
				...
				[
                    ...
                    'col2' => 'রাজমিস্ত্রি',
                    'col3' => '১০',
                    'col4' => 'পাথর, প্লাস্টার, ব্লক, কংক্রিট, টাইলস, শাটারিং এবং অন্যান্য সিভিল কাজে ৫ বছরের অভিজ্ঞতা থাকতে হবে।',
                    'col5' => '১২০০+৩০০',
                    'col6' => 'ফ্রি',
                    'col7' => 'এস.এস.সি বা কারিগরি শিক্ষা পাস হতে হবে।',
                ],
				[
                    ...
                    'col3' => '১০',
                    'col4' => 'স্টিল ফিক্সিং, অন্যান্য ভারী সিভিল ও শাটারিং-এর কাজে ৫ বছরের অভিজ্ঞতা থাকতে হবে।',
                    'col5' => '১২০০+৩০০',
                    'col6' => 'ফ্রি',
                    'col7' => 'এস.এস.সি বা কারিগরি শিক্ষা পাস হতে হবে।',
                ],
        ...
        <table class="table table-bordered text-center align-middle">
            ...
            <tbody>
				...
				<tr>
					<td colspan="7">
						বিশেষ দ্রষ্টব্য: সকল কর্মীকে কোম্পানি কর্তৃক প্রদত্ত যেকোনো ট্রেডে কাজ করার জন্য প্রতিশ্রুতিবদ্ধ থাকতে হবে। ক্রমিক নং ১, ২ ও ৩ পদে মধ্যপ্রাচ্যে অধিক যোগ্যতাসম্পন্ন প্রার্থীর জন্য বেতন ও অন্যান্য সুবিধাদি আলোচনা যোগ্য।
					</td>
				</tr>
            </tbody>
        </table>
