    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-body text-center">
                ...
                <p class="mb-3">Delete this item? This can't be undone.</p>
                <div class="d-flex justify-content-between">
                    <button type="button" class="btn btn-outline-success me-3" data-bs-dismiss="modal">Cancel</button>
                    <a href="#" id="itemConfirmBtn" class="btn btn-outline-danger">Yes, Delete</a>
                </div>
            </div>
        </div>
    </div>
